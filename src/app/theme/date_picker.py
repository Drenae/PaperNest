...
class BaseDatePickerField(PaperNestDatePicker):
    ...
    ``value`` conserve le type natif ``datetime`` fourni par l’extension.
    ``iso_value`` expose explicitement la date civile au format ISO attendu
    par les services de PaperNest.
    """
